...
public class LockerDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseMySql("server=127.0.0.1;uid=root;pwd=4505096Cargo!;database=cargo", new MySqlServerVersion(new Version(8, 0, 21))); // MySQL versiyonuna göre ayarlayın
    }
}
