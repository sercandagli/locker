...
public class AddressToLockerModel(IOrderService orderService, WorkContext workContext) : BasePageModel
{
    ...
    public async Task OnGet()
    {
        ...
        Model = await _orderService.PrepareOrderPage((int)DeliveryType.AddressToLocker, userType);
    ...
    {
        model.DeliveryType = DeliveryType.AddressToLocker;
